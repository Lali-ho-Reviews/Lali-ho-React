      ...
      <div>
        ...
        {this.state.data.map(fc => (
          ...
          <div class="flex flex-col pb-3 pt-1">
            <div
              class="relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-s md:max-w-3xl mx-auto border border-white bg-white">
            <div class="w-full md:w-1/3 bg-white grid place-items-center">
              <img src="/startscreen.jpeg" alt="ff14 loading screen backgorund" class="rounded-xl" />
            </div>
              <div class="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
                <div class="flex justify-between item-center">
                  <p class="text-gray-500 font-sm hidden md:block">Rank: {fc.rank}</p>
                  ...
                  <div class=" px-3 py-1 rounded-full text-sm font-sm text-gray-800 hidden md:block">
